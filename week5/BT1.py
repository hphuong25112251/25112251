...
class DienMay:
    def __init__(self, ma_hang, ten_hang, nha_sx, thoi_gian_bao_hanh, dien_ap, cong_suat):
        super().__init__(ma_hang, ten_hang, nha_sx, thoi_gian_bao_hanh, dien_ap, cong_suat)
        self.ma_hang = ma_hang
        self.ten_hang = ten_hang
        self.nha_sx = nha_sx
...
class SanhSu:
    def  __init__(self, ma_hang, ten_hang, nha_sx, gia, loai_nguyen_lieu):
        super().__init__(ma_hang, ten_hang, nha_sx, gia, loai_nguyen_lieu)
        self.ma_hang = ma_hang
        self.ten_hang = ten_hang
        self.nha_sx = nha_sx
        self.gia = gia
...
class ThucPham:
    def __init__(self, ma_hang, ten_hang, nha_sx, gia, ngay_san_xuat, ngay_het_han_dung):
        super().__init__(ma_hang, ten_hang, nha_sx, gia, ngay_san_xuat, ngay_het_han_dung)
        self.ma_hang = ma_hang 
        self.ten_hang = ten_hang
        self.nha_sx = nha_sx
        self.gia = gia
...
dm = DienMay("DM01", "Tủ lạnh", "Samsung", 15000000, "24 tháng", 220, 150)
